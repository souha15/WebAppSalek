...
namespace WebApplicationPlateforme.Controllers.UserControllers
{
    ...
    public class UserProfileController : ControllerBase
    {
        ...
        [HttpGet]
        [Authorize(Roles = "STAGIAIRE", AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        [Route("ForStagiaire")]
        ...
        [HttpGet]
        [Authorize(Roles = "CONSEILADMIN", AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        ...
        [HttpGet]
        [Authorize(Roles = "SUPCONSEILADMIN", AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        ...
        [HttpGet]
        [Authorize(Roles = "PARTRESP", AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        [Route("ForPartResp")]
        public string GetForPartResp()
        {
            return "Web method for PartResp";
        }


        [HttpGet]
        [Authorize(Roles = "RESP", AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        [Route("ForResp")]
        public string GetForResp()
        {
            return "Web method for Resp";
        }


        [HttpGet]
        [Authorize(Roles = "PARTNORMAL", AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        [Route("ForPartNormal")]
        public string GetForPartNormal()
        {
            return "Web method for PartNormal";
        }


        [HttpGet]
        [Authorize(Roles = "RESPFINANCE", AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        [Route("ForRespFinance")]
        public string GetForRespFinance()
        {
            return "Web method for RespFinance";
        }
        ...
        [HttpGet]
        [Authorize(Roles = "CONSEILADMIN,RESPFINANCE", AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        ...
        [HttpGet]
        [Authorize(Roles = "PARTRESP,RESPFINANCE", AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
