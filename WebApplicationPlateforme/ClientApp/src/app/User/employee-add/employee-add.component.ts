...
export class EmployeeAddComponent implements OnInit {
  ...
  directoreGSelectedRole: boolean = true;
  list: string[] = [];
  updateSelectedRoles(index) {
    ...
    if (index == 4) {
      ...
      this.position = "رئيس مجلس الإدارة"

    }

    if (index == 5) {

      this.position = "نائب رئيس مجلس الإدارة"

    }

    if (index == 9) {

      this.position = "المسؤول"
    ...
    if (index == 7) {
      ...
      this.position = "موظف مالي"

    }

    if (index == 10) {
      this.position = "عضو مالي"    
    }
    ...
    if (index == 3) {
      this.position = "متعاون"
    } 
    if (index == 11) {
      this.position ="سكرتير"
    }
